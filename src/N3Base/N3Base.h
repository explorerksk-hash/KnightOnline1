...
public:
	...
	static CN3Mng<class CN3VMesh>
		s_MngVMesh; // 단순히 폴리곤만 갖고 있는 메시 - 주로 충돌 체크에 쓴다..
	...
	static CN3Mng<class CN3FXPMesh>
		s_MngFXPMesh;            // FX에서 쓰는 PMesh - 파일은 일반 PMesh를 쓰지만 속은 다르다.
	static CN3Mng<class CN3FXShape>
		s_MngFXShape;            // FX에서 쓰는 Shape - 파일은 일반 shape를 쓰지만 속은 다르다.
...
public:
	...
	static const std::string& PathGet()
	{
		return s_szPath;
	}
