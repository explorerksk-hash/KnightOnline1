...
enum e_SendMsgEventIds : int32_t
{
	...
	// Master Quest Events
	EVENTID_MASTER_QUEST_ROGUE = 6012,
...
enum e_SendSayMessageIds : int32_t
{
	...
	// Master Quest Messages
	MSG_NOT_ELIGIBLE_MASTER_WARRIOR  = 6001,
	MSG_NOT_ELIGIBLE_MASTER_ROGUE    = 7001,
	MSG_NOT_ELIGIBLE_MASTER_MAGE     = 8001,
	MSG_NOT_ELIGIBLE_MASTER_PRIEST   = 9001,
	MSG_MASTER_QUEST_DESC_WARRIOR    = 6002,
	MSG_MASTER_QUEST_DESC_ROGUE      = 7002,
	MSG_MASTER_QUEST_DESC_MAGE       = 8002,
	MSG_MASTER_QUEST_DESC_PRIEST     = 9002,
	MSG_COMPLETE_MASTER_WARRIOR      = 6005,
	MSG_COMPLETE_MASTER_ROGUE        = 7005,
	MSG_COMPLETE_MASTER_MAGE         = 8005,
	MSG_COMPLETE_MASTER_PRIEST       = 9005,
	MSG_ALREADY_MASTER_WARRIOR       = 6006,
	MSG_ALREADY_MASTER_ROGUE         = 7006,
	MSG_ALREADY_MASTER_MAGE          = 8006,
	MSG_ALREADY_MASTER_PRIEST        = 9006,
	MSG_MISSING_ITEMS_MASTER_WARRIOR = 6007,
	MSG_MISSING_ITEMS_MASTER_ROGUE   = 7007,
	MSG_MISSING_ITEMS_MASTER_MAGE    = 8007,
	MSG_MISSING_ITEMS_MASTER_PRIEST  = 9007,
	MSG_MASTER_QUEST_ACCEPT_WARRIOR  = 6011,
	MSG_MASTER_QUEST_ACCEPT_ROGUE    = 7011,
	MSG_MASTER_QUEST_ACCEPT_MAGE     = 8011,
	MSG_MASTER_QUEST_ACCEPT_PRIEST   = 9011,

	// User Rank Stipend Messages
