...
| 2 | Ebenezer | `EXEC::Parse: unhandled opcode` — CHANGE_POSITION, MOVE_MIDDLE_STATUE, CHANGE_NAME, SEND_WEBPAGE_ADDRESS, STATE_CHANGE, CHECK_PCBANG_*, SHOW_PCBANG_ITEM, CHECK_PPCARD_SERIAL, GIVE_PPCARD_ITEM, ZONE_CHANGE_PARTY; `EVENT::LoadEvent: unhandled opcode 'TYPE'` (11.evt, 12.evt) | P1 | Sunucu başlangıcı, assets/Server/QUESTS yüklenirken | Açık — upstream eksik quest opcode'ları | — |
| 3 | Ebenezer | `LoadNoticeData: failed to open Notice.txt` | P2 | Başlangıç | Açık — Notice.txt yok; boş dosya ile geçer | — |
...
| 5 | AIServer | `GameSocket::Parsing: Unhandled opcode 32` (Ebenezer → AI, 4 kez başlangıçta) | P2 | Ebenezer bağlanınca | Açık — hangi opcode olduğu bulunacak (Ebenezer AISocket send listesi) | — |
